    ...
    <div className="flex h-screen bg-black text-white">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="border-b border-gray-800 p-4 bg-black">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              {activeTab === 'vacations' && (
                <div className="flex items-center gap-3">
                  <label className="text-sm text-gray-400 font-medium lowercase">your name:</label>
                  <input
                    type="text"
                    value={userName}
                    onChange={(e) => setUserName(e.target.value)}
                    className="bg-gray-900 text-white text-sm border border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:border-gray-500 font-medium lowercase placeholder:lowercase"
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeTab === 'vacations' && (
            <div className="p-6">
              <VacationPlanner userName={userName} />
            </div>
          )}
